...
user in an INI file next to WRRPortable.exe called WRRPortable.ini.
...
copy AppNamePortable.ini from this directory to WRRPortable.ini next to
WRRPortable.exe. The options in the INI file are as follows:
